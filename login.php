...
<section class="auth-panel auth-grid" aria-labelledby="login-title">
    ...
    <div class="auth-form-panel">
        ...
        <?php if ($notice !== ''): ?><div class="auth-notice" role="status" tabindex="-1"><?= auth_escape($notice) ?></div><?php endif; ?>
        <form action="auth.php" method="post" data-auth-form data-auth-mode="login" novalidate>
            <input type="hidden" name="return_to" value="<?= auth_escape($returnTo) ?>">
