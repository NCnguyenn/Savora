...
$authPageTitle = (string) ($registrationResult['title'] ?? 'Registration complete'); $authNavHref = 'login.php'; $authNavLabel = 'Sign in';
...
<div class="auth-actions auth-actions--inline"><a class="auth-button auth-button--secondary" href="register.php">Create another account</a><a class="auth-button" href="login.php">Return to sign in</a></div>
</section>
