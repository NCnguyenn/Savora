...
try {
    ...
    foreach ($items as $item) {
        $restaurants[(string) $item['restaurant']['name']] = true;
        foreach (['description', 'imagePath', 'category', 'prepTimeMinutes', 'calories', 'ingredients'] as $field) {
    ...
    echo "PASS: customer catalog returns 48 rich items across six restaurants\n";
