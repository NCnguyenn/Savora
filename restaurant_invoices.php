...
<main id="restaurant-main" class="restaurant-main" data-documents-page>
    ...
    <div class="restaurant-documents-layout">
        <section class="restaurant-card" aria-labelledby="documents-list-title"><h2 id="documents-list-title">Documents</h2>
            ...
            <section id="document-panel-statements" role="tabpanel" aria-labelledby="document-tab-statements" tabindex="0" data-document-panel="statements" hidden><h3>Payout statements</h3><p class="restaurant-field-hint">Local payout-preview statements are derived from completed and refunded orders.</p><div data-statement-documents aria-live="polite"></div></section>
            <section id="document-panel-tax" role="tabpanel" aria-labelledby="document-tab-tax" tabindex="0" data-document-panel="tax" hidden><h3>Tax documents</h3><p class="restaurant-empty" data-tax-document-empty>No tax documents are available in this local demo. Tax records are not generated here.</p></section>
        </section>
